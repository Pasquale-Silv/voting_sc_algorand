...
class VotingScClient:
    """A class for interacting with the VotingSc app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        VotingScClient can be created with an app_id to interact with an existing application, alternatively
